...
Learn to use web socket in Qt: based on TCP
Try to start building web battle module

### During Girlfriend: 3rd Sept. - 5th Sept.

Learn multi-threading in Qt
Advanced GUI: about web game process
Advanced UserInteraction: about web game process
